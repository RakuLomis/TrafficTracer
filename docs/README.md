...
Unless a page states otherwise, this documentation describes TrafficTracer Complete 1.0.26 on Linux x86-64. Historical release notes retain their original versions. Legacy Session schemas remain readable, but new captures use the current contracts pinned by `complete/components.lock.yaml`.
