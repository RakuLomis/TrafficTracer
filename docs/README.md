...
- [1.0.10 release notes](releases/v1.0.10.md)
...
Unless a page states otherwise, this documentation describes TrafficTracer Complete 1.0.10 on Linux x86-64. Legacy Session schemas remain readable, but new captures use the current contracts pinned by `complete/components.lock.yaml`.
