...
Unless a page states otherwise, this documentation describes TrafficTracer Complete 1.0.1 on Linux x86-64. Legacy Session schemas remain readable, but new captures use the current contracts pinned by `complete/components.lock.yaml`.
