...
TrafficTracer Complete 1.0.28 supports Linux x86-64 and is built on Ubuntu 24.04 LTS. This iteration adds redacted runtime proxy semantics bound to actual Mihomo connections and carriers.

Windows and other Linux architectures are not part of the 1.0.28 build scope.
...
- [TrafficTracer Complete 1.0.28 release notes](docs/releases/v1.0.28.md)
