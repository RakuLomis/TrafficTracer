...
TrafficTracer Complete 1.0.22 supports Linux x86-64 and is built on Ubuntu 24.04 LTS. This iteration is ready for real capture/Resume validation; see the release notes for validation limits.

Windows and other Linux architectures are not part of the 1.0.22 build scope.
...
```bash
cd /path/to/traffictracer-complete-v1.0.22-linux-x86_64
sha256sum -c SHA256SUMS
sudo apt install ./TrafficTracer-Complete_1.0.22_linux_x86_64.deb
```
...
```bash
chmod +x TrafficTracer-Complete_1.0.22_linux_x86_64.AppImage
./TrafficTracer-Complete_1.0.22_linux_x86_64.AppImage
```
...
- [TrafficTracer Complete 1.0.22 release notes](docs/releases/v1.0.22.md)
