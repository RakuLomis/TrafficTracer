...
TrafficTracer Complete 1.0.25 supports Linux x86-64 and is built on Ubuntu 24.04 LTS. This iteration is ready for real capture/Resume validation; see the release notes for validation limits.

Windows and other Linux architectures are not part of the 1.0.25 build scope.
...
- [TrafficTracer Complete 1.0.25 release notes](docs/releases/v1.0.25.md)
