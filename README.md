...
TrafficTracer Complete 1.0.8 supports Linux x86-64. The release is built and validated on Ubuntu 24.04 LTS.

Windows and other Linux architectures are not part of the 1.0.8 release scope.
...
- [TrafficTracer Complete 1.0.8 release notes](docs/releases/v1.0.8.md)
